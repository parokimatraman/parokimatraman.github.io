                    ...
                    <div class="blog-posts-area">
                        ...
                        <div class="single-post-details-area">
                            <div class="post-thumbnail mb-30">
                                <h2 class="post-title mb-3"><?php echo $pengumuman[0]['title'];?></h2>
                                <img src="<?php echo base_url().'assets/uploads/pengumuman/'.$pengumuman[0]['thumb'];?>">
                            </div>
                            <div class="post-content">
                               
                                <?php echo $pengumuman[0]['content'];?> 
                            </div>
                        </div>
